...
```bash
wget https://github.com/svk1987/JIOTVServer/archive/refs/heads/main.zip -N && unzip JIOTVServer-main.zip && rm JIOTVServer-main.zip && mv JIOTVServer-main/ JIOTVServer/
```
